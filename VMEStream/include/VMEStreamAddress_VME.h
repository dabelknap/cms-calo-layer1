...
#define PC_RECV_SIZE    0x0000
#define PC_SEND_SIZE    0x0004
#define PC2ORSC_DATA    0x0008

#define ORSC_RECV_SIZE  0x1000
#define ORSC_SEND_SIZE  0x1004
#define ORSC2PC_DATA    0x1008
